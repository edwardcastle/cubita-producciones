...
const COPY = {
  es: {
    breadcrumbHome: 'Home',
    breadcrumb: 'Booking de Artistas Cubanos',
    h1: 'Booking de Artistas Cubanos para Festivales y Eventos en Europa',
    subtitle: 'Agencia oficial de booking con más de 30 años contratando artistas de salsa, reguetón y timba para festivales, conciertos, fiestas privadas y eventos corporativos en toda Europa.',
    ...
    whyIntro: 'Somos una agencia especializada en booking de artistas cubanos. Nuestro servicio cubre todo el proceso: desde la consulta de disponibilidad hasta la producción del evento.',
    whyBullets: [
    ...
    coverageTitle: 'Cobertura geográfica del booking',
    coverageText: 'Hacemos booking de artistas cubanos para eventos en toda Europa. Países donde operamos habitualmente:',
  ...
  en: {
    breadcrumbHome: 'Home',
    breadcrumb: 'Booking Cuban Artists',
    h1: 'Booking Cuban Artists for Festivals and Events in Europe',
    subtitle: 'Official booking agency with over 30 years booking salsa, reggaeton and timba artists for festivals, concerts, private parties and corporate events across Europe.',
    ...
    whyIntro: 'We are a specialized agency for booking Cuban artists. Our service covers the entire process: from availability inquiry to event production.',
    whyBullets: [
    ...
    coverageTitle: 'Booking coverage area',
    coverageText: 'We book Cuban artists for events all over Europe. Countries we regularly operate in:',
  ...
  fr: {
    breadcrumbHome: 'Home',
    breadcrumb: 'Booking Artistes Cubains',
    h1: 'Booking d\'Artistes Cubains pour Festivals et Événements en Europe',
    subtitle: 'Agence officielle de booking avec plus de 30 ans de réservation d\'artistes de salsa, reggaeton et timba pour festivals, concerts, soirées privées et événements corporatifs en Europe.',
    ...
    whyIntro: 'Nous sommes une agence spécialisée dans le booking d\'artistes cubains. Notre service couvre l\'ensemble du processus : de la demande de disponibilité à la production de l\'événement.',
    whyBullets: [
    ...
    coverageTitle: 'Couverture géographique du booking',
    coverageText: 'Nous faisons le booking d\'artistes cubains pour des événements dans toute l\'Europe. Pays où nous opérons régulièrement :',
  ...
  it: {
    breadcrumbHome: 'Home',
    breadcrumb: 'Booking Artisti Cubani',
    h1: 'Booking di Artisti Cubani per Festival ed Eventi in Europa',
    subtitle: 'Agenzia ufficiale di booking con oltre 30 anni di prenotazione di artisti di salsa, reggaeton e timba per festival, concerti, feste private ed eventi aziendali in tutta Europa.',
    ...
    whyIntro: 'Siamo un\'agenzia specializzata nel booking di artisti cubani. Il nostro servizio copre l\'intero processo: dalla richiesta di disponibilità alla produzione dell\'evento.',
    whyBullets: [
    ...
    coverageTitle: 'Copertura geografica del booking',
    coverageText: 'Facciamo booking di artisti cubani per eventi in tutta Europa. Paesi in cui operiamo regolarmente:',
